...
export default function RecordVideo() {
  ...
  const saveAndSendToBackend = async (recording) => {
    ...
    // Set the file name according to your requirements. I.e. It can be something like userid_randomnumber.mp4
    let videoFilename="dummy.mp4"
    // Send the video data to the backend
    // Replace the following line with your actual backend endpoint and logic
          ...
          <div className="device" key={recording.id}>
            ...
            <div className="preview">
              ...
              <div className="controls">
                ...
                <button onClick={()=>saveAndSendToBackend(recording)}>Upload</button>
              </div>
            </div>
          </div>
        ))}
